...
# CUDA_VISIBLE_DEVICES=4 python main.py --training_mode fine_tune --pretrain_dataset SleepEEG --target_dataset UCI_original
CUDA_VISIBLE_DEVICES=4 python main.py --training_mode fine_tune --pretrain_dataset UCI_original --target_dataset UCI_original --percent 0.01
